...
<!-- 	<div class="boardlist-div-list">
		...
		<ul class="boardlist-ul-list">
            ...
            <li class="boardlist-li-item" onclick="location.href='boardDetail.jsp?id=${board.id}'">
                <span class="board-number">${board.category}</span>
                <span class="board-title">${board.title}</span>
                <span class="board-author">${board.author}</span>
                <span class="board-date">${board.createdDate}</span>
            </li>
        </c:forEach>
    </ul>
</div>
