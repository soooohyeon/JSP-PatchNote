...
<head>
  ...
  <title>지식의 숲</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/board/boardlist.css">
  ...
  <script defer src="${pageContext.request.contextPath}/asset/js/board/boardlist.js"></script>
</head>
...
<hr>
  ...
  <form class="boardlist-form-wrapper" action="">
    <input type="text" class="boardlist-input-search" placeholder="검색어를 입력하세요." />
    <button class="boardlist-btn-search">
      <img src="./../../asset/img/study/search-btn.png" alt="search" class="boardlist-img-search" />
    </button>
  </form>
  ...
  <div class="boardlist-div-list">
    <ul class="boardlist-ul-list">
      <li class="boardlist-li-header">
        <span class="board-number">카테고리</span>
        <span class="board-title">제목</span>
        <span class="board-author">작성자</span>
        <span class="board-date">작성일</span>
      </li>
      <!-- 메인내용용 내용들 -->
      <li class="boardlist-li-item" onclick="movetodetailedpage()">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목1 [숫자]</span>
        <span class="board-author">작성자1</span>
        <span class="board-date">2025-01-11</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목2 [숫자]</span>
        <span class="board-author">작성자2</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목3 [숫자]</span>
        <span class="board-author">작성자3</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목4 [숫자]</span>
        <span class="board-author">작성자4</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목5 [숫자]</span>
        <span class="board-author">작성자5</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목6 [숫자]</span>
        <span class="board-author">작성자6</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목7 [숫자]</span>
        <span class="board-author">작성자7</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목8 [숫자]</span>
        <span class="board-author">작성자8</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목9 [숫자]</span>
        <span class="board-author">작성자9</span>
        <span class="board-date">2025-01-10</span>
      </li>
      <li class="boardlist-li-item">
        <span class="board-number">카테고리</span>
        <span class="board-title">게시판 제목10 [숫자]</span>
        <span class="board-author">작성자10</span>
        <span class="board-date">2025-01-10</span>
      </li>
    </ul>
  </div>
