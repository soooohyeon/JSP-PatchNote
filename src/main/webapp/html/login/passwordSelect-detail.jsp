...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script defer src="${pageContext.request.contextPath}/asset/js/login/passwordSelect-detail.js"></script>
</head>
<body>
	...
	<form action="${pageContext.request.contextPath}/login/passwordUpdateOk.me" method="post" id="updatePwFrom">
		<main>
			...
			<div class="passwordSelect-detail-div-wrapper-allinput-box">
				<div class="passwordSelect-detail-div-wrapper-input-id">
					<input type="password" class="passwordSelect-detail-input-newpwd"
						maxlength="15" placeholder="새로운 비밀번호" name="userPw"
				...
				<div class="passwordSelect-detail-div-wrapper-input-id">
					<input type="password" class="passwordSelect-detail-input-newpwd"
						placeholder="새로운 비밀번호 재입력" name="userRePw" maxlength="15" id="PASSWORDSELECT-INPUT-RENEWPWD" />

				</div>
				<span id="JOIN-SPAN-REPWD-STATUS"></span>
				<button type="button" id="updatePwBtn" class="passwordSelect-detail-btn-complete">완료</button>
			</div>
