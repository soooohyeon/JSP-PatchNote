...
<html lang="en">
  <head>
    ...
    <script
      defer
      src="${pageContext.request.contextPath}/asset/js/mypage/mypage-hostboard.js"
    ></script>
  </head>
  <body>
                ...
                <div class="mypage-div-groupinner">
                  <div class="mypage-div-groupinfowrapper datecontent-wrap">
                    <div class="mypage-div-enddate">
                      마감일 &nbsp;| &nbsp; ${myStudyList.studyDeadline}
                    </div>

                    <div
                      class="mypage-div-morebtn"
                    ...
                    <div id="modal-list" class="modal hidden">
                      <ul>
                        ...
                        <li
                          onclick="openApplicantModal(`${myStudyList.studyNum}`)"
                        >
                          신청자
                        </li>
                      </ul>
                  ...
                  <div class="mypage-div-grouptitle">
                    <a
                      href="${pageContext.request.contextPath}/study/studyDetailOk.st?studyNum=${myStudyList.studyNum}"
                      >${myStudyList.studyTitle}</a
                    >
                  </div>
