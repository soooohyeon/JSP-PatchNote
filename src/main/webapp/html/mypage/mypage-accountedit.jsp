	...
	<div class="main-container">
		...
		<div id="ADMIN-DIV-HEADERCONTAINER">
			...
			<ul id="ADMIN-UL-HEADERWRAP">
				<li><a href="${request.getContextPath}/main/main-login.jsp">홈</a></li>
				<li><a href="${request.getContextPath}/main/main-logout.jsp">로그아웃</a></li>
			</ul>
		</div>
		...
		<main>
			<div class="mypage-div-main">
				<div class="mypage-title">
					...
					<br />
					<p>
						개인 정보 설정을 관리하여 나에게 맞는 방식으로 지식의 숲을 사용할 수 있습니다. <a href="">자세히
							알아보기</a>
					</p>
				</div>
				<section class="mypage-section">
					<div class="mypage-div-wrapper">
						<label for="name">이름</label> <input type="text" id="name"
							value="<%=request.getAttribute("name") != null ? request.getAttribute("name") : "도깨비"%>"
							readonly>
					</div>
					<div class="mypage-div-wrapper">
						<label for="birthdate">생년월일</label> <input type="text"
							id="birthdate"
							value="<%=request.getAttribute("birthdate") != null ? request.getAttribute("birthdate") : "0930-03-03"%>"
							readonly>
					</div>
					<div class="mypage-div-wrapper">
						<label for="ID">ID</label> <input type="text" id="ID"
							value="<%=request.getAttribute("id") != null ? request.getAttribute("id") : "dokev333"%>"
							readonly>
					</div>
					...
					<div class="mypage-div-wrapper2">
						...
						<button class="mypage-btn-nickname" id="nickdupChkButton"
							onclick="validateNickname()">중복검사</button>
					</div>
					<div id="nickname-error"></div>

					<div class="mypage-div-wrapper">
						<label for="password">비밀번호</label> <input type="password"
							id="password" onkeydown="validatePasswordLive()">
					</div>
					...
					<div class="mypage-div-wrapper2">
						<div class="editpage-input-phoneNumchk">
							<label for="phoneNumchk">인증번호 확인</label> <input type="text"
								id="phoneNumchk" placeholder="인증번호를 입력해주세요">
						</div>
