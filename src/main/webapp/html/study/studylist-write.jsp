        ...
        <form id="STUDYLIST-FORM-WRITE" action="${pageContext.request.contextPath}/study/studyWriteOk.st" method="post" enctype="multipart/form-data">
          ...
          <div class="studylist-div-wrapperlayerDual">
            <div class="studylist-div-infowrapperDual">
			  ...
			  <!-- 숨겨진 input -->
			  <input type="hidden" name="studyCat" id="studyCategory" value="0">
			</div>
			
            <div class="studylist-div-infowrapperDual">
              <div class="label">전화번호</div>
              <div class="studylist-div-phoneselectwrapper">
                <div class="studylist-div-shownumberselector phoneselected" name="studyShowph" data-value="0">
                  보이기
                </div>
                <div class="studylist-div-shownumberselector" name="studyShowph" data-value="1">숨기기</div>
              </div>
            </div>
			  <!-- 숨겨진 input -->
			  <input type="hidden" name="studyShowph" id="showPhone" value="0">
          </div>
          <!-- 2개씩 나눠진 div layer -->
          <div class="studylist-div-wrapperlayerDual">
            <div class="studylist-div-infowrapperDual">
