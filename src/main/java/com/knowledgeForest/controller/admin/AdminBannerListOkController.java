...
public class AdminBannerListOkController implements Execute {
...
//		키워드 여부로 유저 목록 조회
		...
		bannerList = adminDAO.selectBannerAll(paramMap);

//		총 공지 글 수
		total = adminDAO.getBannerTotal(keyword);
...
//	    목록 설정
		...
		result.setPath("/html/admin/admin-bannerlist.jsp");
